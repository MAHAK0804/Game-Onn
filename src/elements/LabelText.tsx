...
export default function LabelText({ text }: ILabelText) {
  return (
    <>
      <h3 className="py-3 lg:py-0 bg-gradient-to-r from-[#262626] to-[#B8C2CE] text-transparent bg-clip-text text-md font-bold text-start md:m-auto   lg:mt-15 lg:mb-2 uppercase">
        {text}
      </h3>
